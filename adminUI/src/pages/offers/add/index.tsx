...
const CarAddition = () => {
  ...
  //   try {
  //     const response = await axios.post('http://localhost:9758/api/Car/addCar', data);
      ...
      <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        ...
        <AccordionDetails>
          <Grid container spacing={5}>
            ...
            <Grid item xs={6} sm={3}>
              <FormControl fullWidth>
                <InputLabel id='brand-label'>Version</InputLabel>
                <Select
                  labelId='brand-label'
                  id='brand-select'
                  // value={brand}
            ...
            <Grid item xs={6} sm={3}>
              <FormControl fullWidth>
                <InputLabel id='brand-label'>Year</InputLabel>
                <Select
                  labelId='brand-label'
                  id='brand-select'
                  // value={brand}
        ...
        <AccordionDetails>
          <Grid container spacing={5}>
            <Grid item xs={12} sm={3}>
              <FormControl fullWidth>
                <InputLabel id='brand-label'>Available Colour</InputLabel>
                <Select
                  labelId='brand-label'
                  id='brand-select'
                  // value={brand}
        ...
        <AccordionDetails>
          <Grid container spacing={5}>
                  ...
                  <Grid container spacing={5}>
                    ...
                    <Grid item xs={12} sm={6}>
                      <TextField
                        ...
                        placeholder='allowedNumberOfKMs'
                    ...
                    <Grid item xs={12} sm={6}>
                      <TextField
                        fullWidth
                        label='Available For Daily Rental'
                        placeholder='availableForDailyRental'
                        {...register('availableForDailyRental')}
                      />
                    </Grid>
                  </Grid>
                </AccordionDetails>
                ...
                <AccordionDetails>
                  <Grid container spacing={5}>
                    ...
                    <Grid item xs={12} sm={6}>
                      <TextField
                        fullWidth
                        label='Available For Weekly Rental'
                        placeholder='availableForWeeklyRental'
                        {...register('availableForWeeklyRental')}
                      />
                    </Grid>
                  </Grid>
                </AccordionDetails>
            ...
            <Grid item xs={12} sm={3}>
              <TextField
                fullWidth
                label='CDW Insurrance Per Day'
                placeholder='cdwInsurancePerDay'
        ...
        <AccordionDetails>
          <Grid container spacing={5}>
            ...
            <Grid item xs={12} sm={3}>
              <TextField
                fullWidth
                label='Delivery & Pick-up Charges'
                placeholder='Delivery & Pick-up Charges'
                ...
                <AccordionDetails>
                  <Grid container spacing={5}>
                    ...
                    <Grid item xs={12} sm={6}>
                      <TextField
                        fullWidth
                        label='Charges After Free KMs'
                        placeholder='chargesAfterFreeKMs'
                        {...register('chargesAfterFreeKMs')}
                      />
                    </Grid>
                  </Grid>
                </AccordionDetails>
